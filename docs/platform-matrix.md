...
|---|---:|---:|---:|---|
| Windows 10/11 x64 | Yes | No | Windows 10 development host | Converter/loader/session tests pass locally |
...
| Windows 10 x86 build | Design check | No | Windows 10 development host | Converter/loader/session/ABI tests pass locally |
