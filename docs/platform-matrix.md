...
|---|---:|---:|---:|---|
| Windows 10/11 x64 | Yes | No | Windows 10 development host | 15/15 REC operator types pass local reference tests |
...
| Windows 10 x86 build | Design check | No | Windows 10 development host | 15/15 REC operator types pass local reference tests |
